// Dynamic course details page component
      ...
      {/* Course content section */}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            {/* About section */}
            <section className="p-6 bg-card/50 backdrop-blur-sm border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
           ...
           <section className="p-6 bg-card/50 backdrop-blur-sm border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
            ...
            <section>
              ...
              <div className="space-y-4">
                {/* Curriculum modules */}
                <div className="p-4 bg-black border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
                  <h3 className="font-semibold mb-2 text-[#1DDFEA]">Module 1: Introduction to ML</h3>
                  <p className="text-white">Basic concepts and terminology</p>
                </div>
                <div className="p-4 bg-black border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
                  <h3 className="font-semibold mb-2 text-[#1DDFEA]">Module 2: Supervised Learning</h3>
                  <p className="text-white">Classification and regression techniques</p>
                </div>
                <div className="p-4 bg-black border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
                  <h3 className="font-semibold mb-2 text-[#1DDFEA]">Module 3: Neural Networks</h3>
                  <p className="text-white">Deep learning fundamentals</p>
                </div>
              </div>
            </section>
          </div>

          {/* Sidebar with course features */}
          <div>
            <div className="sticky top-20 p-6 bg-card/50 backdrop-blur-sm border border-border rounded-lg hover:border-[#1DDFEA]/50 transition-all duration-300">
              ...
              <Button className="w-full mt-6 bg-blue-900 hover:bg-[#1DDFEA]/90 text-white">
                Enroll Now
              </Button>
            </div>
          </div>
